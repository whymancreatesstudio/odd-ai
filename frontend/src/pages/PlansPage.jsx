...
const PlansPage = () => {
    ...
    const handleBackToApp = () => {
        // Close this tab and return to main app
        window.close();
        // If window.close() doesn't work (due to browser security), redirect to main app
        if (!window.closed) {
        ...
        <div className={`min-h-screen ${bgColor} ${textColor} transition-colors duration-300`}>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                            <span className={`text-sm ${secondaryTextColor}`}>New Tab</span>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
                ...
                <div className="text-center mt-8">
                    <button
                        onClick={handleBackToApp}
                        className={`px-6 py-3 ${isDark ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-200 hover:bg-gray-300'} ${textColor} font-medium rounded-xl transition-all duration-200`}
                    >
                        ← Return to Main App
                    </button>
                </div>
